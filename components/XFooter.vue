<template> 
  <div id="footer" class="bg-[#14071B] text-white pt-[7rem]"> 
    <div class="flex flex-col sm:flex-row pb-[5rem] b-wrapper gap-[2rem]">
      ...
      <div class="w-full">
        <div class="w-full mb-[1rem]">
          <p class="text-[#626262] mb-[1rem]">Phone:</p>
          <p class="font-semibold">{{ footer.phone }}</p>
        </div>
        <div class="w-full">
          <p class="text-[#626262] mb-[1rem]">Email:</p>
          <p class="font-semibold">{{ footer.email }}</p>
        </div>
      </div>
      <div class="w-full">
        <div class="w-full">
          ...
          <ul class="flex flex-row gap-[2.6rem]"> 
            ...
            <li>
              <a :href="footer.instagram" id="ins" target="_blank">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M7.2 0C5.29044 0 3.45909 0.758569 2.10883 2.10883C0.758569 3.45909 0 5.29044 0 7.2L0 16.8C0 18.7096 0.758569 20.5409 2.10883 21.8912C3.45909 23.2414 5.29044 24 7.2 24H16.8C18.7096 24 20.5409 23.2414 21.8912 21.8912C23.2414 20.5409 24 18.7096 24 16.8V7.2C24 5.29044 23.2414 3.45909 21.8912 2.10883C20.5409 0.758569 18.7096 0 16.8 0L7.2 0ZM6.4 12C6.4 10.5148 6.99 9.09041 8.0402 8.0402C9.09041 6.99 10.5148 6.4 12 6.4C13.4852 6.4 14.9096 6.99 15.9598 8.0402C17.01 9.09041 17.6 10.5148 17.6 12C17.6 13.4852 17.01 14.9096 15.9598 15.9598C14.9096 17.01 13.4852 17.6 12 17.6C10.5148 17.6 9.09041 17.01 8.0402 15.9598C6.99 14.9096 6.4 13.4852 6.4 12ZM17.6 6.4H19.2V4.8H17.6V6.4Z" fill="#626262"/>
                </g>
                <defs>
                <clipPath id="clip0_1317_3283">
                <rect width="24" height="24" fill="white"/>
                </clipPath>
                </defs>
                </svg>
            ...
            <li>
              <a :href="footer.twitter" id="tw" target="_blank">
                ...
                3.44669 17.9526 2.88086 16.5267 2.88086C13.8673 2.88086 11.6945 5.05365 11.6945 7.7357C11.6945 8.12046 
                11.7398 8.49391 11.819 8.84473C7.79025 8.64103 4.20288 6.70588 1.81507 3.77487C1.39636 4.48782 1.15871 
                5.32525 1.15871 6.20795C1.15871 7.89413 2.00745 9.38792 3.32018 10.2367C2.5167 10.2367 1.7698 10.0103 
                1.11344 9.67084V9.70479C1.11344 12.0587 2.7883 14.0277 5.00636 14.4691C4.29424 14.664 3.54662 14.6911 
                2.82225 14.5483C3.12962 15.513 3.73158 16.3572 4.54353 16.9621C5.35548 17.567 6.33657 17.9022 7.34891 
                17.9207C5.63288 19.2792 3.50577 20.0135 1.31714 20.0029C0.932373 20.0029 0.547607 19.9803 0.162842 
                19.935C2.313 21.3157 4.87056 22.1191 7.60919 22.1191C16.5267 22.1191 21.4268 14.7181 21.4268 8.30153C21.4268 8.08651 21.4268 7.88281 21.4155 7.6678C22.3661 6.9888 23.1809 6.12873 23.8372 5.14419Z" fill="#626262"/>
                </svg>
            ...
            <li>
              <a :href="footer.linkedin" id="ln" target="_blank">
                ...
                19.2951V4.70691C23.994 2.1217 21.879 0.00585938 19.2937 0.00585938H4.70556ZM5.88795 3.96461C7.1275 3.96461 
                7.89101 4.77836 7.91458 5.84801C7.91458 6.89405 7.12745 7.73067 5.86397 7.73067H5.84072C4.62476 7.73067 
                3.83883 6.8941 3.83883 5.84801C3.83883 4.77838 4.64854 3.96461 5.88792 3.96461H5.88795ZM16.5699 8.96405C18.9538 
                8.96405 20.7408 10.5222 20.7408 13.8705V20.1213H17.118V14.2896C17.118 12.8242 16.5936 11.8244 15.2825 11.8244C14.2816 
                11.8244 13.685 12.4982 13.4231 13.1492C13.3274 13.3821 13.3039 13.7074 13.3039 14.0332V20.1213H9.68103C9.68103 20.1213 
                9.72857 10.2426 9.68103 9.2197H13.3046V10.7635C13.7861 10.0207 14.6473 8.96403 16.5699 8.96403V8.96405ZM4.05253 9.22049H7.6754V20.1213H4.05253V9.22049Z" fill="#626262"/>
                </g>
                <defs>
                <clipPath id="clip0_1317_3288">
                <rect width="24" height="24" fill="white"/>
                </clipPath>
                </defs>
                </svg>
    ...
    <div class="b-wrapper text-[#7D7D7D] border-t p-[3.2rem] border-[#291732] text-center border-solid">
      © {{agencyName}} {{ new Date().getFullYear() }}. All rights reserved.
    </div>
  </div>
</template>
...
const logo = computed(() => props.data?.agency_wizard.logo_light || '/img/logo-light.svg');
...
const footer = computed(() => {
  ...
  const instagram = props.data?.agency_wizard.contact.socials.instagram || "#";
  const twitter = props.data?.agency_wizard.contact.socials.youtube || "#";
  return {
    address,
    instagram,
    linkedin,
